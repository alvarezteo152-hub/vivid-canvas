...
const translations = {
  eu: {
    ...
    contact: { kicker: "Kontaktua", title: "Etorri gose bazaude", address: "Helbidea", phone: "Telefonoa", schedule: "Ordutegia", schedShort: ["Al-Ar: itxita", "Az-Og: 17:00 — 23:00"], maps: "Ikusi Google Maps-en", fullSchedule: "Ordutegi osoa" },
    menuSections: [
    ...
    schedule: [
      ["Asteazkena eta osteguna", "17:00 — 23:00"],
      ["Ostirala", "17:00 — 00:00"],
      ["Larunbata", "10:00 — 00:00"],
      ["Igandea", "11:00 — 23:00"],
      ["Astelehena eta asteartea", "Itxita"],
    ],
    closedLabel: "Itxita",
  },
  es: {
    ...
    contact: { kicker: "Contacto", title: "Ven si tienes hambre", address: "Dirección", phone: "Teléfono", schedule: "Horario", schedShort: ["Lun-Mar: cerrado", "Mié-Dom: 17:00 — 23:00"], maps: "Ver en Google Maps", fullSchedule: "Horario completo" },
    menuSections: [
    ...
    schedule: [
      ["Miércoles y jueves", "17:00 — 23:00"],
      ["Viernes", "17:00 — 00:00"],
      ["Sábado", "10:00 — 00:00"],
      ["Domingo", "11:00 — 23:00"],
...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground scroll-smooth">
      ...
      {/* Featured */}
      <section id="menu" className="py-28 px-6 bg-background">
